...
/**
 * Hole2 Class - one of Toby's obstacle that removes one life if toby touches it.
 * 
...
{   
    ...
    /**
     * reviveToby() - bring back Toby to initial position if life count is higher than 0.
     */
